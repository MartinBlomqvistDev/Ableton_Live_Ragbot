...
def generate_response(
    ...
    system_prompt = (
        ...
        "Use only the context below — don't make things up. "
        "If the context covers the question, give a short, direct answer. "
        "If it only partly covers it, use what's there and point toward the relevant part of the manual. "
        f"If the context has nothing to do with the question, say: '{no_answer}'"
    )
